...
<div class="formCadastro">
 <h1 class="cadastro"><mtw:i18n key="licenca.titulo"/></h1>
 
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
  <form name="formulario"  id="formulario" action="licenca.atualiza.action" method="post">
 </c:when>
 <c:otherwise>
  <form name="formulario" id="formulario" action="licenca.novo.action" method="post">
 </c:otherwise> 
</c:choose>

 <div class="row">
  <span class="label">
   <mtw:i18n key="licenca.nome"/>:
  </span>
  <span class="form">
...
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
    ...
    <form name="formulario" action="licenca.action" method="post"><input type="submit" name="tipoCRUD" value="Voltar" />
  </span>
 </div>
...
<mtw:list value="licencas">
 <h1 class="cadastro"><mtw:i18n key="licenca.lista"/></h1>
 <mtw:isEmpty>
 ...
 <mtw:loop counter="contador">
   <ul id="resultlist">
     <li> 
       <a href="licenca.buscaUm.action?id=<mtw:out value="id"/>"><mtw:out value="nome"/></a>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="licenca.remove.action?id=<mtw:out value="id"/>">X</a> ] 
     </li>
   </ul>
