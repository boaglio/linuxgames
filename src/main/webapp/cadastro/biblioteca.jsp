...
<div class="formCadastro">
 <h1 class="cadastro"><mtw:i18n key="biblioteca.titulo"/></h1>
 
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
  <form name="formulario"  id="formulario" action="biblioteca.atualiza.action" method="post">
 </c:when>
 <c:otherwise>
  <form name="formulario" id="formulario" action="biblioteca.novo.action" method="post">
 </c:otherwise> 
</c:choose>

 <div class="row">
  <span class="label">
   <mtw:i18n key="biblioteca.nome"/>:
  </span>
  <span class="form">
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="biblioteca.link"/>:
  </span>
  <span class="form">
   <mtw:input type="text" name="link" maxlength="50" size="50"/>
  </span>
 </div> 
 <div class="spacer">
  &nbsp;
...
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
    ...
    <form name="formulario" action="biblioteca.action" method="post"><input type="submit" name="tipoCRUD" value="Voltar" />
  </span>
 </div>
...
<mtw:list value="bibliotecas">
 <h1 class="cadastro"><mtw:i18n key="biblioteca.lista"/></h1>
 <mtw:isEmpty>
 ...
 <mtw:loop counter="contador">
   <ul id="resultlist">
     <li> 
       <a href="biblioteca.buscaUm.action?id=<mtw:out value="id"/>"><mtw:out value="nome"/></a>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="biblioteca.remove.action?id=<mtw:out value="id"/>">X</a> ] 
     </li>
   </ul>
