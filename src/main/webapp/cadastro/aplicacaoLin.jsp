...
<div class="formCadastro">
 <h1 class="cadastro"><mtw:i18n key="aplicacao.titulo.lin"/></h1>

<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
  <form name="formulario"  id="formulario" action="aplicacaoLin-atualiza" method="post">
 </c:when>
 <c:otherwise>
  <form name="formulario" id="formulario" action="aplicacaoLin-novo" method="post">
 </c:otherwise>
</c:choose>
...
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
    ...
    <form name="formulario" action="aplicacaoLin.action" method="post"><input type="submit" name="tipoCRUD" value="Voltar" />
  </span>
 </div>
...
<mtw:list value="aplicacoes">
 ...
 <mtw:loop >
   <ul id="resultlist">
     <li>
       <a href="aplicacaoLin.buscaUm.action?id=<mtw:out value="id"/>"><mtw:out value="nome"/> - <mtw:out value="link"/></a>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="aplicacaoLin.remove.action?id=<mtw:out value="id"/>">X</a> ]
     </li>
   </ul>
 </mtw:loop>
   <br><br>
   <div class="c">
    <mtw:hasPrevious><a href="aplicacaoLin.action?page=<mtw:out />"><img src="/img/anterior.png" alt="" width="16" height="16"/></a></mtw:hasPrevious>
    <mtw:pageNumbers pagesToShow="10">
     <mtw:isCurrPage><b><font size="+1"><mtw:out /></font></b></mtw:isCurrPage>
     <mtw:isCurrPage negate="true"><a href="aplicacaoLin.action?page=<mtw:out />"><mtw:out /></a></mtw:isCurrPage>
    </mtw:pageNumbers>
    <mtw:hasNext><a href="aplicacaoLin.action?page=<mtw:out />"><img src="/img/posterior.png" alt="" width="16" height="16"/></a></mtw:hasNext>
