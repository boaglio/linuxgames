...
<div class="formCadastro">
 <h1 class="cadastro"><mtw:i18n key="versaoDeEmulador.titulo"/></h1>

<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
  <form name="formulario"  id="formulario" action="versaoDeEmulador.atualiza.action" method="post">
 </c:when>
 <c:otherwise>
  <form name="formulario" id="formulario" action="versaoDeEmulador.novo.action" method="post">
 </c:otherwise>
</c:choose>

 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeEmulador.release"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeEmulador.obs"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeEmulador.link"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeEmulador.dataLancamento"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeEmulador.tipo"/>:
  </span>
...
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
    ...
    <form name="formulario" action="versaoDeEmulador.action" method="post"><input type="submit" name="tipoCRUD" value="Voltar" />
  </span>
 </div>
...
<mtw:list value="versoesDeEmuladores">
 <h1 class="cadastro"><mtw:i18n key="versaoDeEmulador.lista"/></h1>
 <mtw:isEmpty>
 ...
 <mtw:loop  var="registro">
   <ul id="resultlist">
     <li>
       (<fmt:formatDate value="${registro.dataLancamento}" pattern="dd/MM/yyyy"/>) - <a href="versaoDeEmulador.buscaUm.action?id=<mtw:out value="id"/>"><mtw:out value="release"/> - <mtw:out value="link"/> [ <c:out value="${registro.emulador.nome}"/> ]</a>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="versaoDeEmulador.remove.action?id=<mtw:out value="id"/>">X</a> ]
     </li>
   </ul>
 </mtw:loop>
   <br><br>
   <div class="c">
    <mtw:hasPrevious><a href="versaoDeEmulador.action?page=<mtw:out />"><img src="/img/anterior.png" alt="" width="16" height="16"/></a></mtw:hasPrevious>
    <mtw:pageNumbers pagesToShow="10">
     <mtw:isCurrPage><b><font size="+1"><mtw:out /></font></b></mtw:isCurrPage>
     <mtw:isCurrPage negate="true"><a href="versaoDeEmulador.action?page=<mtw:out />"><mtw:out /></a></mtw:isCurrPage>
    </mtw:pageNumbers>
    <mtw:hasNext><a href="versaoDeEmulador.action?page=<mtw:out />"><img src="/img/posterior.png" alt="" width="16" height="16"/></a></mtw:hasNext>
