...
<div class="formCadastro">
 <h1 class="cadastro"><mtw:i18n key="versaoDeDistro.titulo"/></h1>

<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
  <form name="formulario"  id="formulario" action="versaoDeDistro.atualiza.action" method="post">
 </c:when>
 <c:otherwise>
  <form name="formulario" id="formulario" action="versaoDeDistro.novo.action" method="post">
 </c:otherwise>
</c:choose>

 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeDistro.release"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeDistro.obs"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeDistro.link"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeDistro.dataLancamento"/>:
  </span>
 ...
 <div class="row">
  <span class="label">
   <mtw:i18n key="versaoDeDistro.tipo"/>:
  </span>
  <mtw:select name="tipo_id" list="DISTROS" />
  <mtw:hasError>
...
<c:choose>
 <c:when test="${actionCRUD == buscaUm}">
    ...
    <form name="formulario" action="versaoDeDistro.action" method="post"><input type="submit" name="tipoCRUD" value="Voltar" />
  </span>
 </div>
...
<mtw:list value="versoesDeDistros">
 <h1 class="cadastro"><mtw:i18n key="versaoDeDistro.lista"/></h1>
 <mtw:isEmpty>
 ...
 <mtw:loop  var="registro" counter="contador">
   <ul id="resultlist">
     <li>
       (<fmt:formatDate value="${registro.dataLancamento}"/>) - <a href="versaoDeDistro.buscaUm.action?id=<mtw:out value="id"/>"><mtw:out value="release"/> - <mtw:out value="link"/> [ <c:out value="${registro.distro.nome}"/> ]</a>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="versaoDeDistro.remove.action?id=<mtw:out value="id"/>">X</a> ]
     </li>
   </ul>
