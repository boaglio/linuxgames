...
public class DistroValidation  extends ValidationFilter {
	...
	public void prepareValidator(Validator validator, Action action,String innerAction) {
		...
		validator.add("abreviacao", RequiredFieldRule.getInstance(),"campoObrigatorio");
		validator.add("siteOficial", RequiredFieldRule.getInstance(),"campoObrigatorio");
		validator.add("linkLogo", RequiredFieldRule.getInstance(),"campoObrigatorio");
